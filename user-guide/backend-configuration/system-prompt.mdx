...
**Agent description** - Role or personality that sets the tone

**Goals** - What the agent should accomplish

**Instructions** - Specific rules and behavior constraints

**Expected output** - Response format (JSON, bullets, summary, etc)
