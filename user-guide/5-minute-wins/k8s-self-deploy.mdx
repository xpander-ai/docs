...
- **[Visual Agent Builder to Code](/user-guide/5-minute-wins/visual-agent-to-code)** - Create agents on your infrastructure
- **[OpenAPI Spec to MCP Tool](/user-guide/5-minute-wins/openapi-to-mcp)** - Deploy MCP servers to your cluster
- **[Connect to Slack](/user-guide/5-minute-wins/slack-agent-setup)** - Team integrations
...
<AccordionGroup>
  ...
  <Accordion title="Need help">
    Full deployment guide: [Self-Hosted Deployment](/user-guide/self-hosted-deployment)
  </Accordion>
</AccordionGroup>
