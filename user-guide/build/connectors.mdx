...
<Note>
To create and manage MCP servers, compose tools from multiple connectors, or use agents as MCP servers, see the [MCP Task Source](/user-guide/scale/mcp) documentation.
</Note>
