...
Planning provides six built-in tools that agents use to manage their execution plans:
...
<CardGroup cols={2}>
  <Card title="Reasoning" icon="brain-circuit" href="/user-guide/build/reasoning-mode">
