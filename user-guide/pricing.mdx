...
When you're ready to scale beyond the free tier, add a credit card to activate pay-as-you-go pricing. You'll automatically transition to usage-based billing when you exceed free limits.

**How it works:**

1. **Start free** - No credit card required to begin building
2. **Add payment** - Add a credit card when you're ready to scale
3. **Automatic transition** - Pay-as-you-go activates when you exceed free tier limits
4. **Monthly billing** - Usage is billed in fixed resource packs at month-end
