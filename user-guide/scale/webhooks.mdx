...
Use `params_mapping` to dynamically extract values from your webhook payload and map them to query parameters. This is especially useful for integrations with Telegram bots, WhatsApp, and other messaging platforms where user/chat identifiers are nested in the payload.
