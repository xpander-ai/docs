...
The default values for each setting are intelligently generated by the Planner based on your prompt description. However, in most cases, you’ll want to customize them to better fit your specific needs and use case. You can refer to [this section of the xpander docs](https://xpander.ai/docs/user-guide/backend-configuration/ai-model) to learn more about these settings.
