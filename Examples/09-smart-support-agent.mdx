...
<Tip>
  **Quick Start**: Use the pre-built template at [Xpander.ai Support Agent Template](https://xpander.ai/docs/templates/03-support-agent) to get started in minutes rather than building from scratch.
</Tip>