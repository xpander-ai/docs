...
<Frame>
  <video autoPlay muted loop playsInline controls allowFullScreen className="w-full aspect-video" src="https://assets.xpanderai.io/examples/workshops/videos/swe-send-task.mp4" />
</Frame>
...
<Frame>
  <video autoPlay muted loop playsInline controls allowFullScreen className="w-full aspect-video" src="https://assets.xpanderai.io/examples/workshops/videos/swe-track-result.mp4" />
</Frame>
