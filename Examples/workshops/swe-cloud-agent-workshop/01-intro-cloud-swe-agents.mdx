...
<a 
  href="https://app.xpander.ai/examples/templates/14c5e651-a207-4a60-8dd6-143e147df890?utm=swe-workshop-sf-july25" 
  target="_blank" 
  style={{
...
<Frame>
![post-template](/images/examples/workshops/post-template.png)
</Frame>
...
<Frame>
  <video autoPlay muted loop playsInline controls allowFullScreen className="w-full aspect-video" src="https://assets.xpanderai.io/examples/workshops/videos/swe-authorize-github.mp4" />
</Frame>
...
<Frame>
![Serverless coding agent](/images/examples/workshops/serverless-coding-agent.png)
</Frame>
...
<Frame>
![Step 1 capabilities](/images/examples/workshops/swe-capabilities.png)
</Frame>
...
<Frame>
![Full view](/images/examples/workshops/full-view-action.png)
</Frame>
...
<Frame>
![Step 3 PR Summary](/images/examples/workshops/pr-summary.png)
</Frame>
...
<Frame>
![alt text](/images/examples/workshops/cli-icon.png)
</Frame>
