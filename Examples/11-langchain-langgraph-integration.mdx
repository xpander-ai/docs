...
xpander's advanced [output schema filtering](https://xpander.ai/docs/user-guide/backend-configuration/connectors#tool-scheme-advanced-tab) helps you:
...
- 📚 **Documentation**: [xpander.ai/docs](https://xpander.ai/docs)
