...
<Frame>
  <video muted loop playsInline controls allowFullScreen className="w-full aspect-video" src="https://assets.xpanderai.io/GitHub_PR_Review_Agent_Demo.mp4" />
</Frame>
...
<Frame>
  ![Xpander Dashboard](/images/examples/github-pr-review/Screenshot_2025-07-11_at_20.34.28.png)
</Frame>
...
<Frame>
  ![Agent SDK panel](/images/examples/github-pr-review/Screenshot_2025-07-14_at_12.31.16.png)
</Frame>
...
<Frame>
  ![Agent processing](/images/examples/github-pr-review/Screenshot_2025-07-14_at_13.27.17.png)
</Frame>

<Frame>
  ![Slack notification](/images/examples/github-pr-review/Screenshot_2025-07-14_at_13.13.35.png)
</Frame>
...
For more advanced agent patterns, explore the [Xpander.ai documentation](https://xpander.ai/docs).