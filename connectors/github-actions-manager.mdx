...
<Tabs>
  ...
  <Tab title="API Access">
    ...
    4. Enter an **Interface name**, e.g., "xpander-github-actions-manager".  
...
2. Select **Connectors**.  
3. Choose **Github Actions Manager** with the same **Interface name** you configured in the previous section (e.g., xpander-github-actions-manager).  
...
1. Go to the **Connectors** section in the sidebar of your xpander.ai dashboard.  
2. Select **Github Actions Manager** with the same **Interface name** you configured in the previous section (e.g., xpander-github-actions-manager).  
