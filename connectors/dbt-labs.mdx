...
<Tabs>
  ...
  <Tab title="API Access">
    ...
    2. In the bottom of the sidebar in your account dashboard, click on your profile, and select **Your profile**.

    ![Img 1](/images/connectors/dbt-labs/img_1.png)

    3. Choose **Personal tokens** in the sidebar, and then click on **Create personal access token**.

    ![Img 2](/images/connectors/datadog/img_2.png)

    4. Give your access token a name, and then click **Save**.
    5. Copy your personal access token somewhere safe before closing the dialog box.
