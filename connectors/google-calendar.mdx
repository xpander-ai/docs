...
<Tabs>
  ...
  <Tab title="API Access">
    ...
    4. Enter an **Interface name**, e.g., "xpander-google-calendar".  
...
2. Select **Connectors**.  
3. Choose **Google Calendar** with the same **Interface name** you configured in the previous section (e.g., xpander-google-calendar).  
...
1. Go to the **Connectors** section in the sidebar of your xpander.ai dashboard.  
2. Select **Google Calendar** with the same **Interface name** you configured in the previous section (e.g., xpander-google-calendar).  
