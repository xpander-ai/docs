...
<Tabs>
  ...
  <Tab title="API Access">
    ...
    3. Click **Enable**.  
    4. Enter an **Interface name**, e.g., "xpander-supabase".  
...
2. Select **Connectors**.  
3. Choose **Supabase** with the same **Interface name** you configured in the previous section (e.g., xpander-supabase).  
...
1. Go to the **Connectors** section in the sidebar of your xpander.ai dashboard.  
2. Select **Supabase** with the same **Interface name** you configured in the previous section (e.g., xpander-supabase).  
