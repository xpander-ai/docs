...
<Tabs>
  ...
  <Tab title="API Access">
    ...
    4. Enter an **Interface name**, e.g., "xpander-jira".  
...
2. Select **Connectors**.  
3. Choose **Jira** with the same **Interface name** you configured in the previous section (e.g., xpander-jira).  
...
1. Go to the **Connectors** section in the sidebar of your xpander.ai dashboard.  
2. Select **Jira** with the same **Interface name** you configured in the previous section (e.g., xpander-jira).  
