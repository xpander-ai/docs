---
title: "How to Build an Agent to Transform Text into Structured Output with xpander"
...
![img_1](/images/tutorial_2/xp_img_1.png)
...
![img_2](/images/tutorial_2/xp_img_2.png)
...
![img_3](/images/tutorial_2/xp_img_3.png)
...
![img_4](/images/tutorial_2/xp_img_4.png)
...
To enable these operations, you need to grant xpander a permission to access your Google Drive and Google Docs account.
...
4. Give the interface a name of your choice.
5. Proceed with the authentication method that works best for you.

![img_5](/images/tutorial_2/xp_img_5.png)
...
![img_6](/images/tutorial_2/xp_img_6.png)

You can also fine-tune your agent’s settings by clicking the gear icon at the top right of the agent box in the graph. There, you can configure options like the LLM provider, model, memory strategy, and more.

## Using Chat and Visual Tester to Check Agent’s Workflow

There are several ways to interact with your AI agent in xpander: Chat, SDK, and Webhook. Out of these options, Chat is the fastest way to interact with and test your agent’s workflow. Once everything is set up and you’ve granted the necessary interface permissions, you can use the Chat and Visual Tester features in the Workbench to try things out.
...
![img_7](/images/tutorial_2/xp_img_7.png)
...
![img_8](/images/tutorial_2/xp_img_8.png)
...
If you want to test the agent with your team, you can easily share it. Just click the “Chat” node at the top of the graph visualization, and you’ll see a unique URL for the agent. Anyone with the link can interact with the agent via a Chainlit-powered chat interface.

![img_9](/images/tutorial_2/xp_img_9.png)
...
![img_10](/images/tutorial_2/xp_img_10.png)
...
![img_11](/images/tutorial_2/xp_img_11.png)
...
![img_12](/images/tutorial_2/xp_img_12.png)
...
![img_13](/images/tutorial_2/xp_img_13.png)
...
Now, let’s start by creating a task for our agent to execute. We can do this using the `add_task()` method, passing in our input prompt as the argument. After that, we need to initialize the agent’s memory with the task.
...
![img_14](/images/tutorial_2/xp_img_14.png)
