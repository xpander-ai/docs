...
print(f"🔍 View this agent in the Xpander platform with ID: {os.environ['XPANDER_AGENT_ID']}")
...
```python
from xpander_sdk import Agent, XpanderClient, LLMProvider, ToolCallResult, GraphItem, Tokens, LLMTokens
from openai import OpenAI
import os
import time
from datetime import datetime
...
agent = xpander_client.agents.get(agent_id=os.environ['XPANDER_AGENT_ID'])
print(f"🔄 Loaded agent: {agent.name}")
print(f"🔍 View this agent in the Xpander platform with ID: https://app.xpander.ai/agents/{os.environ['XPANDER_AGENT_ID']}")
...
if tavily_ready:
    ...
    print("\n⏰ Testing agent with time function only...")
