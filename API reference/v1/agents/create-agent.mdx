...
1. Update instructions using [Update Agent](../agents/update-agent)
2. Deploy the agent using [Deploy Agent](../agents/deploy-agent)
3. Invoke the agent using [Invoke Agent](../agents/invoke-async)