...
1. Update instructions using [Update Agent](/api-reference-rest/agents/update-agent)
2. Deploy the agent using [Deploy Agent](/api-reference-rest/agents/deploy-agent)
3. Invoke the agent using [Invoke Agent](/api-reference-rest/agents/invoke-async)