...
- Improved documentation for LLM provider integration ([docs/01-get-started/03-llm-models.mdx](/docs/01-get-started/03-llm-models))
...
- Support for OpenAI, Claude, and Gemini LLM integration ([docs/01-get-started/03-llm-models.mdx](/docs/01-get-started/03-llm-models))
...
- Enhanced documentation with provider-specific integration guides ([docs/01-get-started/03-llm-models.mdx](/docs/01-get-started/03-llm-models))
...
## 2024-11-11
- Added support for Gemini via OpenAI-compatible API (SDK v0.7.5, [docs/01-get-started/03-llm-models.mdx](/docs/01-get-started/03-llm-models))
