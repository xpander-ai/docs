...
- Improved message format handling for all providers ([api-reference/07-sdk/client/index.mdx](/sdk-reference/07-sdk/client/index))
...
- Basic memory management and tool execution framework ([api-reference/07-sdk/xpander-sdk/agent.mdx](/sdk-reference/07-sdk/xpander-sdk/agent))
...
- Improved memory consistency across multi-turn conversations ([api-reference/07-sdk/xpander-sdk/agent.mdx](/sdk-reference/07-sdk/xpander-sdk/agent))
- Released new Python client with simplified API ([api-reference/07-sdk/xpander-sdk/XpanderClient.mdx](/sdk-reference/07-sdk/xpander-sdk/XpanderClient))
...
- Support for simple tool calling and execution ([api-reference/07-sdk/xpander-sdk/Agent.Tools.mdx](/sdk-reference/07-sdk/xpander-sdk/Agent.Tools))
- Initial memory management capabilities ([api-reference/07-sdk/xpander-sdk/agent.mdx](/sdk-reference/07-sdk/xpander-sdk/agent))
