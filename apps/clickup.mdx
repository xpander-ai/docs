...
<Tabs>
  ...
  <Tab title="API Access">
    ...
    2. Click on your account icon in the top-right corner and select **Settings**.  
       ![Img 1](/images/apps/clickup/img_1.png)
    3. In the sidebar, go to **Apps** and click **Generate**.  
       ![Img 2](/images/apps/clickup/img_2.png)
    ...
    ![Img 3](/images/apps/clickup/img_3.png)
...
![Img 4](/images/apps/clickup/img_4.png)
...
![Img 5](/images/apps/clickup/img_5.png)
