...
<Tabs>
  ...
  <Tab title="API Access">
    ...
    2. Click your profile icon in the top-right corner and select **Settings**.  
       ![Img 1](/images/apps/github-actions-manager/img_1.png)
    ...
    5. Click **Generate new token**, then select **Generate new token (classic)**.  
       ![Img 2](/images/apps/github-actions-manager/img_2.png)
    ...
    9. Save the configuration.  
       ![Img 3](/images/apps/github-actions-manager/img_3.png)
...
![Img 4](/images/apps/github-actions-manager/img_4.png)
...
![Img 5](/images/apps/github-actions-manager/img_5.png)
