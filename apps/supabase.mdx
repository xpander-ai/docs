...
<Tabs>
  ...
  <Tab title="API Access">
    ...
    2. Click your profile icon at the top right of the dashboard, then select **Account preferences**.  
       ...
       ![Img 1](/images/apps/supabase/img_1.png)

    3. In the sidebar, click **Access tokens**, then click **Generate new token**.  

       ![Img 2](/images/apps/supabase/img_2.png)
    ...
    ![Img 3](/images/apps/supabase/img_3.png)
...
![Img 4](/images/apps/supabase/img_4.png)
...
![Img 5](/images/apps/supabase/img_5.png)
