...
<Tabs>
  ...
  <Tab title="API Access">
    ...
    2. Navigate to **Project Settings** in the sidebar, then click on **Data API**.  
       ...
       ![Img 1](/images/apps/supabase-database/img_1.png)
    ...
    5. Under **General settings**, you'll see your project ID—save this ID for later use.  
       ...
       ![Img 2](/images/apps/supabase-database/img_2.png)
    ...
    ![Img 3](/images/apps/supabase-database/img_3.png)
...
![Img 4](/images/apps/supabase-database/img_4.png)
...
![Img 5](/images/apps/supabase-database/img_5.png)
