...
<Tabs>
  <Tab title="API Access">
    ...
    3. Set up and configure the scope of the app to your liking. Once you're done, click **Create app**.\
       ![Img 1](/images/apps/dropbox/img_1.png)
    ...
    5. Under **Generated access token**, click **Generate**, and you'll see your access token.\
       ![Img 2](/images/apps/dropbox/img_2.png)
    ...
    3. Click **Enable**.
    4. Fill in the **Interface name** as desired, e.g., "xpander-dropbox".
    ...
    ![Img 3](/images/apps/dropbox/img_3.png)
  </Tab>
  <Tab title="Tab">
...
2. Select **Apps**.
3. Choose **Dropbox** with the same **Interface name** you configured in the previous section (e.g., xpander-dropbox).
4. Select the available Dropbox operations that suit your use case.

![Img 4](/images/apps/dropbox/img_4.png)
...
1. Go to the **Interfaces** section in the sidebar of your xpander.ai dashboard.
2. Select **Dropbox** with the same **Interface name** you configured in the previous section (e.g., xpander-dropbox).
...
![Img 5](/images/apps/dropbox/img_5.png)
