...
<Tabs>
  ...
  <Tab title="API Access">
    ...
    2. Navigate to **Integrations**, then select **API Access Keys** under **Developer Tools**:
       ...
       ![Img 1](/images/apps/pagerduty/img_1.png)
    ...
    5. Click **Create Key**—your API key will be displayed immediately after.
       ...
       ![Img 2](/images/apps/pagerduty/img_2.png)
    ...
    10. Save the configuration.  
        ...
        ![Img 3](/images/apps/pagerduty/img_3.png)
...
![Img 4](/images/apps/pagerduty/img_4.png)
...
![Img 5](/images/apps/pagerduty/img_5.png)
