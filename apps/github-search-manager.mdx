...
<Tabs>
  ...
  <Tab title="API Access">
    ...
    2. Click on your profile icon in the top-right corner, then select **Settings**.  
       ![Img 1](/images/apps/github-search-manager/img_1.png)
    ...
    5. Click **Generate new token**, and then **Generate new token (classic)**.  
       ![Img 2](/images/apps/github-search-manager/img_2.png)
    ...
    4. Enter an **Interface name**, e.g., "xpander-github-search-manager".  
    ...
    ![Img 3](/images/apps/github-search-manager/img_3.png)
...
2. Select **Apps**.  
3. Choose **Github Search Manager** with the same **Interface name** you configured in the previous section (e.g., xpander-github-search-manager).  
4. Select the available Github Search Manager operations that suit your use case.  

![Img 4](/images/apps/github-search-manager/img_4.png)
...
1. Go to the **Apps** section in the sidebar of your xpander.ai dashboard.  
2. Select **Github Search Manager** with the same **Interface name** you configured in the previous section (e.g., xpander-github-search-manager).  
...
![Img 5](/images/apps/github-search-manager/img_5.png)
