...
<Tabs>
  ...
  <Tab title="API Access">
    ...
    ![Img 1](/images/apps/hubspot-blogs/img_1.png)
    ...
    4. Enter an **Interface name**, e.g., "xpander-hubspot-blogs".  
    ...
    ![Img 4](/images/apps/hubspot-blogs/img_4.png)
...
2. Select **Apps**.  
3. Choose **HubSpot Blogs** with the same **Interface name** you configured in the previous section (e.g., xpander-hubspot-blogs).  
4. Select the available HubSpot Blogs operations that suit your use case.  

![Img 5](/images/apps/hubspot-blogs/img_5.png)
...
1. Go to the **Interfaces** section in the sidebar of your xpander.ai dashboard.  
2. Select **HubSpot Blogs** with the same **Interface name** you configured in the previous section (e.g., xpander-hubspot-blogs).  
...
![Img 6](/images/apps/hubspot-blogs/img_6.png)
