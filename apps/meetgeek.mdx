...
<Tabs>
  <Tab title="API Access">
    ...
    2. In the sidebar of your dashboard, choose **Integrations** -\> **Public API**.
       ![Img 1](/images/apps/meetgeek/img_1.png)
    3. You'll see your MeetGeek API key.
       ![Img 2](/images/apps/meetgeek/img_2.png)
    ...
    3. Click **Enable**.
    4. Fill in the **Interface name** as desired, e.g., "xpander-meetgeek".
    ...
    ![Img 3](/images/apps/meetgeek/img_3.png)
  </Tab>
</Tabs>
...
2. Select **Apps**.
3. Choose **MeetGeek** with the same **Interface name** you configured in the previous section (e.g., xpander-meetgeek).
4. Select the available MeetGeek operations that suit your use case.

![Img 4](/images/apps/meetgeek/img_4.png)
...
1. Go to the **Interfaces** section in the sidebar of your xpander.ai dashboard.
2. Select **MeetGeek** with the same **Interface name** you configured in the previous section (e.g., xpander-meetgeek).
...
![Img 5](/images/apps/meetgeek/img_5.png)
