...
<CardGroup cols={3}>
  <Card title="Getting Started" icon="rocket" href="/docs/01-get-started/02-sdk-overview">
    Begin building with xpander.ai
  </Card>
  <Card title="Examples" icon="code" href="/docs/01-get-started/examples">
    Sample implementations and use cases
  </Card>
  <Card title="Concepts" icon="lightbulb" href="/docs/01-get-started/concepts">
