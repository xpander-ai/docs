---
title: "XpanderClient"
description: "Main client for interacting with the Xpander platform"
icon: "plug"
---

The `XpanderClient` is the main entry point for the Xpander SDK, providing access to agents, tools, and other resources on the Xpander platform.
...
|-----------|--------|----------|------------------------|
| `api_key` | string | Yes      | Your Xpander API key   |
