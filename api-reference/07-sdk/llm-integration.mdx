...
<Tabs>
  ...
  <Tab title="Message Format">
    ...
    xpander.ai SDK stores all messages in a standard format in `agent.messages`. This format is compatible with OpenAI and OpenAI-compatible APIs out of the box.
