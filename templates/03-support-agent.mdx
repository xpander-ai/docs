...
- Deploying a support agent in your community Slack or joint customer channels for instant, AI-powered help. Read more at [Slack Agents](/user-guide/scale/slack)
...
1. **Connect to Slack**  
   Integrate your Support Agent with Slack to provide instant support in your team's workspace, community workspace, or joint customer channels. See the [Slack Agents](/user-guide/scale/slack) documentation for setup instructions.
