...
Click this link to open the Coding Agent template: [Coding Agent Template](https://app.xpander.ai/templates/02ee3226-55ef-447d-b122-c2968f937155)
...
1. **Connect to Slack**  
   Integrate your Coding Agent with Slack to provide instant coding support and assistance in your team's workspace. See the [Slack Agents](/docs/05-human-interfaces/02-slack-agents) documentation for setup instructions.
