...
Before getting started with the xpander CLI (v0.0.37), ensure you have the following requirements:

<CardGroup cols={1}>
  <Card title="System Requirements" icon="computer">
    - **Node.js 16+**: The CLI requires Node.js version 16 or higher
    - **Package Manager**: npm (comes with Node.js) or yarn
    - **Internet Connection**: Stable internet connection for API communication and package downloads
  </Card>
</CardGroup>

<Note>
You can check your Node.js version by running `node --version` in your terminal. If you need to install or update Node.js, visit [nodejs.org](https://nodejs.org/).
</Note>
...
<Steps>
  <Step title="Create a new agent">
    ...
    The CLI will guide you through the agent creation process, including:
    - **Agent naming**: Choose a descriptive name for your agent
    - **Template selection**: Pick from available templates based on your use case
    - **Configuration options**: Set up initial parameters and preferences
