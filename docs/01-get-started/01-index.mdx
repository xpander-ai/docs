...
description: "Deploy AI Agents that think, act, and scale — across any stack, with zero lock-in"
icon: "house"
---
...
<CardGroup cols={3}>
  ...
  <Card title="Human Interfaces" icon="comments" color="#0EA5E9" href="/docs/05-human-interfaces/02-slack-bots">
