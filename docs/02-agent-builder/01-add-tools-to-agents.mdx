  ...
  <Tab title="Using the UI">
    ...
    <Steps>
      <Step title="Access the Tools Panel">
        ...
        <Frame>
          ![image.png](/Screenshot2025-05-20at17.19.07.png)
        </Frame>
      </Step>
      ...
      <Step title="Add to Agent">
        ...
        <Frame>
          ...
          ![Agentic Interfaces Library](/Screenshot2025-05-20at17.25.30.png)
        </Frame>
      </Step>
    </Steps>
    <Frame>
...
<Accordion title="Popular Apps">
  xpander.ai provides app interfaces for various services including:
  ...
  Each app interface offers operations with different capabilities and requirements.
</Accordion>
