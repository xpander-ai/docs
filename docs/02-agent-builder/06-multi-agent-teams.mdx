...
description: "Learn how to create and manage multi-agent teams in Xpander"
icon: "users"
---

## Creating Multi-Agent Teams

Xpander allows you to create teams of specialized agents that work together to accomplish complex tasks. 
...
Xpander supports two primary team layouts:
...
You can execute multi-agent workflows programmatically using the Xpander SDK. The general pattern involves:
...
1. Configure your environment with OpenAI and Xpander API keys
2. Initialize both the Xpander and OpenAI clients
3. Load your agent or agents from Xpander
...
For most use cases, you can treat the entire agent team as a single entity. The Xpander SDK handles all the complexity of agent switching behind the scenes.
...
Once your team is configured, you can test it through multiple interfaces provided by Xpander:
