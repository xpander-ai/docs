...
1. Navigate to your agent in the Xpander dashboard
...
All agent settings can be accessed and modified programmatically using the Xpander SDK:
...
- [Learn about Agent Graph System](/docs/02-agent-builder/01-agent-graph-system)
- [Add specialized tools to your agents](/docs/02-agent-builder/02-add-tools-to-agents)
