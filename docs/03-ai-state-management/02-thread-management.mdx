...
<CardGroup cols={2}>
  <Card title="Agent Execution" icon="play" href="/api-reference/07-sdk/Tasks">
    Learn how to manage agent execution flow
  </Card>
  <Card title="Agent.Messages" icon="code" href="/api-reference/07-sdk/Agent.Messages">
    Detailed API reference for agent messages
  </Card>
  <Card title="Stateful Agents Guide" icon="brain" href="/docs/03-ai-state-management/03-agent-state">
