...
Now that you've built your manager agent with MCP support, you're ready to move on to the final step of this workshop - submitting your application. In the [next module](/workshops/a2a-mcp-workshop/05-submit-application), you'll finalize your project and prepare it for submission.