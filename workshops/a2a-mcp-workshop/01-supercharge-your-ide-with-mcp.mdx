...
👉 The generated details created for us the agent settings. We still need to optimize the System Prompt of AI Agent to exactly match our use case.
...
<Frame>![](/images/screenshots/2025-05-07-23-01-57.png)</Frame>
...
Now that you've supercharged your IDE with an optimized GitHub MCP Server, you're ready to build your first coding agent in the [next module](/workshops/a2a-mcp-workshop/02-first-coding-agent).