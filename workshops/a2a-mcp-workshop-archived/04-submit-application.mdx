...
<Note>
Change the _my-github-username_ part to your GitHub username
</Note>
...
You can also go to the Activity tab in your Manager AI Agent and see the progress.
...
- [xpander.ai Documentation](https://xpander.ai/docs)
