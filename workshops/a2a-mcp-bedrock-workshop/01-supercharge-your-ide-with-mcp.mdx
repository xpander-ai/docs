...
<Frame>![](/images/screenshots/2025-05-07-11-14-05.png)</Frame>

3. Select the same conversation thread from your chat history to maintain context

<Frame>![](/images/screenshots/2025-05-07-11-15-16.png)</Frame>
...
1. In your agent canvas, by attachling lines between operations, you can connect your nodes to create the dependency graph
