---
title: "Welcome"
description: "Build custom Bedrock and serverless AI agents that collaborate to streamline development tasks and assist with coding"
icon: "rocket"
---
...
<CardGroup cols={2}>
  <Card title="1. Supercharge Your IDE with MCP" icon="bolt" href="/workshops/a2a-mcp-bedrock-workshop/01-supercharge-your-ide-with-mcp" color="#4A2C99">Build a GitHub agent that connects to your IDE.</Card>
  <Card title="2. Build Your First Coding Agent" icon="code" href="/workshops/a2a-mcp-bedrock-workshop/02-first-coding-agent" color="#4A2C99">Create a Bedrock agent that handles code tasks.</Card>
  <Card title="3. Expand Your Agent Fleet" icon="users" href="/workshops/a2a-mcp-bedrock-workshop/03-expand-agent-fleet" color="#753CFF">Add a second agent with different capabilities.</Card>
  <Card title="4. Build a Manager Agent" icon="sitemap" href="/workshops/a2a-mcp-bedrock-workshop/04-serverless-manager-agent" color="#9B70FF">Create an agent that coordinates your other agents.</Card>
  <Card title="5. Build & Submit Your Application" icon="rocket" href="/workshops/a2a-mcp-bedrock-workshop/05-submit-application" color="#4A2C99">Build and submit a project with your agents.</Card>
</CardGroup>
...
Start with [Module 1](/workshops/a2a-mcp-bedrock-workshop/01-supercharge-your-ide-with-mcp). 