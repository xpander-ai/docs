...
MAXIMUM_STEPS_SOFT_LIMIT=9
MAXIMUM_STEPS_HARD_LIMIT=10
...
MAXIMUM_STEPS_SOFT_LIMIT=18 ## PAY ATTENTION THAT WE SET HIGHER LIMITS IN THE CLOUD
MAXIMUM_STEPS_HARD_LIMIT=20 ## PAY ATTENTION THAT WE SET HIGHER LIMITS IN THE CLOUD
MODEL_ID = "us.anthropic.claude-3-7-sonnet-20250219-v1:0"
```
