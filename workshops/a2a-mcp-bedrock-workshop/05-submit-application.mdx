...
```bash example prompt
Develop a single page finance dashboard app and add it to xpander-ai/apps-by-agents Make sure to follow the CONTRIBUTING.md in the repo User name of the owner of the app "xpander-ai"
```
