...
* **Prerequisites**: Completion of Module 1, access to AWS Bedrock
</Note>

In this module, you'll expand your agent fleet by creating additional developer agents with different LLM models and specialized behaviors. This will allow you to leverage the unique strengths of different models and create a more robust AI development team.
...
Update the requirements.txt file to include only the necessary packages:
