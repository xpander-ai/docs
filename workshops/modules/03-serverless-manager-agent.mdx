...
description: "Create a serverless agent that orchestrates and monitors your coding agent fleet using MCP"
icon: "sitemap"
---

# Module 3: Build Your Serverless Manager Agent

In this module, you'll create a serverless manager agent that will oversee, coordinate, and orchestrate the work of your coding agents. This manager will serve as the central intelligence that delegates tasks and aggregates results, all accessible through the Model Context Protocol (MCP) from your Cursor IDE.
...
✅ By the end of this module, you should have a fully operational Serverless Manager Agent that can orchestrate your coding agent fleet, monitor their performance, and integrate with your Cursor IDE via the Model Context Protocol (MCP).
