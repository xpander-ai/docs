...
- **Prerequisites**: Python 3.12.7, Node.js v22, completed Modules 1–3
...
```text
Add a simple, cool and beautiful shazam like app (HTML, CSS, JS) to xpander-ai/apps-by-agents. do it in one-shot
```

![Chat Shazam App](/images/workshops/chat-shazam-app.png)
![Chat Shazam App PR](/images/workshops/chat-shazam-app-pr.png)
...
![Events handler](/images/workshops/events-handler.png)
...
![xpander deploy](/images/workshops/xpander-deploy.png)
...
| Benefit            | Description                                |
| ------------------ | ------------------------------------------ |
| 🧠 Custom Logic    | Full control via `_agent_loop()`           |
| 🛠 Add Tools       | Custom Python functions as callable tools  |
| 🧲 Cloud + Local   | Hybrid tool orchestration                  |
| 📦 One-Line Deploy | `xpander deploy` ready                     |
| 🔍 Metrics         | Built-in observability and token reporting |

---

## ➕ Continue

→ Submit your app in [Module 3](../03-submit-competition)
→ Or explore chaining agents and tool networks via **MCP**!
