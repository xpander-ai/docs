...
```python
thread = await agent.chat("Add a simple, cool and beautiful shazam like app (HTML, CSS, JS) to xpander-ai/apps-by-agents.")
```
...
```text
Add a simple, cool and beautiful AI Agents registry & discovery app (HTML, CSS, JS) with mock agents to xpander-ai/apps-by-agents.
```
