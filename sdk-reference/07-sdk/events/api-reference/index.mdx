...
- [`AgentExecutionInput`](/sdk-reference/07-sdk/types#agentexecutioninput): Task input structure
- [`OutputFormat`](/sdk-reference/07-sdk/types#outputformat): Output format options

## Related Documentation

- [Events Module](/sdk-reference/07-sdk/events): Full events module documentation
- [Tasks Module](/sdk-reference/07-sdk/tasks): Task management and execution
- [Agents Module](/sdk-reference/07-sdk/agents): Agent creation and management
