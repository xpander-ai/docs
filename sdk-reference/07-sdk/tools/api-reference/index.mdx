...
**Raises:**
- [`ModuleException`](/sdk-reference/07-sdk/exceptions): If there's an error accessing the tools repository.
...
**Returns:** [`ToolInvocationResult`](/sdk-reference/07-sdk/types#toolinvocationresult) with execution details and success status.
...
**Returns:** [`ToolInvocationResult`](/sdk-reference/07-sdk/types#toolinvocationresult) with execution details.
...
- [`ToolInvocationResult`](/sdk-reference/07-sdk/types#toolinvocationresult): Tool execution result details
...
- [`Agent`](/sdk-reference/07-sdk/agents/api-reference/agent): Agents that use tools for task execution
- [`Configuration`](/sdk-reference/07-sdk/configuration): SDK configuration

## Related Modules

- [Agents Module](/sdk-reference/07-sdk/agents): Agent management and tool usage
- [Tasks Module](/sdk-reference/07-sdk/tasks): Task execution using tools
