...
For more details on task management, see the [Tasks API Reference](/sdk-reference/07-sdk/tasks/api-reference).

---

Continue to the [Agents API Reference](/sdk-reference/07-sdk/agents/api-reference) for detailed documentation on classes and methods.
