...
**Returns:** Complete [`Agent`](/sdk-reference/07-sdk/agents/api-reference/agent.mdx) object with full configuration.
...
**Raises:**
- [`ModuleException`](/sdk-reference/07-sdk/exceptions.mdx): If the agent cannot be loaded or access is denied.
...
- [`Agents`](/sdk-reference/07-sdk/agents/api-reference): Parent class for agent management
- [`Agent`](/sdk-reference/07-sdk/agents/api-reference/agent.mdx): Full agent with complete capabilities
- [`Configuration`](/sdk-reference/07-sdk/configuration/api-reference): SDK configuration
