...
- [`Agents`](/sdk-reference/07-sdk/agents/api-reference): Main class for managing multiple agents
- [`AgentsListItem`](/sdk-reference/07-sdk/agents/api-reference/agents-list-item): Summary representation of an agent
- [`ToolsRepository`](/sdk-reference/07-sdk/tools/api-reference/tools-repository): Repository for managing tools

## Related Modules

- [Tasks Module](/sdk-reference/07-sdk/tasks)
