...
**Raises:**
- [`ModuleException`](/sdk-reference/07-sdk/exceptions): If the task is not found or access is denied.
...
**Related:** [AgentExecutionStatus](/sdk-reference/07-sdk/types#agentexecutionstatus)
...
**Raises:**
- [`ModuleException`](/sdk-reference/07-sdk/exceptions): If the save operation fails.
...
**Raises:**
- [`ModuleException`](/sdk-reference/07-sdk/exceptions): If the task cannot be stopped.
...
**Related:** [TaskUpdateEvent](/sdk-reference/07-sdk/types#taskupdateevent), [TaskUpdateEventType](/sdk-reference/07-sdk/types#taskupdateeventtype)
...
- [`Agent`](/sdk-reference/07-sdk/agents/api-reference/agent): Agent that creates and manages tasks

## Related Types

- [AgentExecutionStatus](/sdk-reference/07-sdk/types#agentexecutionstatus): Task execution statuses
- [TaskUpdateEvent](/sdk-reference/07-sdk/types#taskupdateevent): Event data structure
- [TaskUpdateEventType](/sdk-reference/07-sdk/types#taskupdateeventtype): Event type enumeration
- [AgentExecutionInput](/sdk-reference/07-sdk/types#agentexecutioninput): Task input configuration

## Related Modules

- [Agents Module](/sdk-reference/07-sdk/agents): Create and manage agents
