...
<CardGroup cols={2}>
  <Card title="Backend" icon="server" href="/sdk-reference/07-sdk/backend">
    **Agents Backend** - Get framework specific arguments for AI agents.
  </Card>
  <Card title="Agents" icon="robot" href="/sdk-reference/07-sdk/agents">
    **Agent Management** - Create, configure, and manage AI agents with tools, knowledge bases, and execution capabilities.
  </Card>
  <Card title="Tasks" icon="play" href="/sdk-reference/07-sdk/tasks">
  ...
  <Card title="Knowledge Bases" icon="database" href="/sdk-reference/07-sdk/knowledge">
    **Knowledge Management** - Create and search knowledge repositories with semantic search capabilities.
  </Card>
  <Card title="Events" icon="bars-progress" href="/sdk-reference/07-sdk/events">
